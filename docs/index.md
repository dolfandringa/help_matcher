...
| --- | --- | --- |
| ![WhatsApp help request initial message](images/whatsapp-help-request-step-1.svg) | ![WhatsApp help request follow-up questions](images/whatsapp-help-request-step-2.svg) | ![WhatsApp help request registered demand](images/whatsapp-help-request-step-3.svg) |
...
The sample records are based on the request screenshots in `images/sample_help_requests/`, with placeholder phone numbers for safety.
